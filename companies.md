## Список компаний и проектов с ГИС в Беларуси
 ...
 * flespi - платформа позволяющая подключить на данный момент 880+ типов GPS устройств использующих 100+ протоколов и конвертировать данные в единый json формат сообщений обрабатывать и забирать по REST/MQTT
